> ### Lithe vendor note
>
> This directory is a source-only snapshot of [t8y2/dbx](https://github.com/t8y2/dbx), pinned to commit
> [`996ce42e80387bba4b33a2bf1713f590ef79d476`](https://github.com/t8y2/dbx/commit/996ce42e80387bba4b33a2bf1713f590ef79d476).
> It intentionally contains no `.git` directory, is not a submodule or a runtime dependency, and is excluded from
> Lithe's application packaging. It exists only as an auditable upstream reference while selected ideas are reviewed
> and independently implemented in Lithe. See the upstream `LICENSE` for the Apache-2.0 license.
